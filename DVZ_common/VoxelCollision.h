...
namespace Physics {
	...
	void face_block_sample(glm::vec3 next_pos, Component::VoxelCollision &collision, GetBlockFunc &func);
	glm::vec3 face_collision_handling(glm::vec3 pos, glm::vec3 vel, Physics::AABB aabb, float delta, GetBlockFunc &func);

	void edge_block_sample(glm::vec3 next_pos, Component::VoxelCollision &collision, GetBlockFunc &func);
	glm::vec3 edge_collision_handling(glm::vec3 pos, glm::vec3 vel, Physics::AABB aabb, float delta, GetBlockFunc &func);

	void corner_block_sample(glm::vec3 next_pos, Component::VoxelCollision &collision, GetBlockFunc &func);
